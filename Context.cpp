...
// window title
static const string title= "cg1 assignment 5 - Ray tracing";

// windows
static Window mainWindow, renderWindow, worldWindow;
...
static void reshape(int width, int height){
  ...
  renderWindow.reshape(GAP, GAP, width, height);
...
static void createWindows(void){
  ...
  renderWindow= Window(&mainWindow, string(), GAP, GAP, subWidth, subHeight);
  renderWindow.registerDisplay(RayTrace::display);
  renderWindow.registerReshape(RayTrace::reshape);
  renderWindow.registerMousePressed(RayTrace::mousePressed);
  renderWindow.registerMouseDragged(RayTrace::mouseDragged);
  renderWindow.registerMouseMoved(RayTrace::mouseMoved);
  renderWindow.registerKeyPressed(Common::keyPressed);
